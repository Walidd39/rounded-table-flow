...
import { Zap, Crown, Star, Rocket, Check } from 'lucide-react';
...
export const MinutesRecharge: React.FC = () => {
  const { user } = useAuth();
    ...
    <div className="py-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-foreground mb-4">
          Recharger vos minutes
        </h2>
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Choisissez votre pack de minutes d'appels IA pour votre restaurant
        </p>
      </div>
